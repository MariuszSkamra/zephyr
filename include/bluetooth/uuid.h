...
/** @def BT_UUID_HAS_FEATURES_VAL
 *  @brief Hearing Aid Features Characteristic value
 */
#define BT_UUID_HAS_FEATURES_VAL 0xAAAA
/** @def BT_UUID_HAS_FEATURES
 *  @brief Hearing Aid Features Characteristic
 */
#define BT_UUID_HAS_FEATURES \
	BT_UUID_DECLARE_16(BT_UUID_HAS_FEATURES_VAL)
/** @def BT_UUID_HAS_CONTROL_POINT_VAL
 *  @brief Hearing Aid Preset Control Point Characteristic value
 */
#define BT_UUID_HAS_CONTROL_POINT_VAL 0xBBBB
/** @def BT_UUID_HAS_CONTROL_POINT
 *  @brief Hearing Aid Preset Control Point Characteristic
 */
#define BT_UUID_HAS_CONTROL_POINT \
	BT_UUID_DECLARE_16(BT_UUID_HAS_CONTROL_POINT_VAL)
/** @def BT_UUID_HAS_ACTIVE_PRESET_VAL
 *  @brief Active Preset Index Characteristic value
 */
#define BT_UUID_HAS_ACTIVE_PRESET_VAL 0xCCCC
/** @def BT_UUID_HAS_ACTIVE_PRESET
 *  @brief Active Preset Index Characteristic
 */
#define BT_UUID_HAS_ACTIVE_PRESET \
	BT_UUID_DECLARE_16(BT_UUID_HAS_ACTIVE_PRESET_VAL)
